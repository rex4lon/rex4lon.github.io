(function () {
    ...
    Lampa.SettingsApi.addParam({
        ...
        param: {
            ...
            type: 'input',
            placeholder: 'https://jellyfin.brama24.xyz',
            values: '',
            default: 'https://jellyfin.brama24.xyz'
        },
        field: {
            name: 'Адреса сервера Jellyfin',
            description: 'Наприклад: https://jellyfin.brama24.xyz'
        }
    });
    ...
    Lampa.SettingsApi.addParam({
        ...
        param: {
            ...
            type: 'input',
            placeholder: '3c683816bf314b3c9bbf45e93334dc69',
            values: '',
            default: '3c683816bf314b3c9bbf45e93334dc69'
        },
        field: {
            name: 'API Ключ',
    ...
    if (!Lampa.Storage.get('jellyfin_nas_server', '')) {
        Lampa.Storage.set('jellyfin_nas_server', 'https://jellyfin.brama24.xyz');
    }
    if (!Lampa.Storage.get('jellyfin_nas_token', '')) {
        Lampa.Storage.set('jellyfin_nas_token', '3c683816bf314b3c9bbf45e93334dc69');
    }
    ...
    Lampa.Settings.listener.follow('open', function (e) {
        if (e.name == 'jellyfin_config') {
            ...
            checkBtn.off('hover:enter click').on('hover:enter click', function () {
                var url = Lampa.Storage.get('jellyfin_nas_server', 'https://jellyfin.brama24.xyz').replace(/\/$/, '').trim();
                var token = Lampa.Storage.get('jellyfin_nas_token', '3c683816bf314b3c9bbf45e93334dc69').trim();
    ...
    function getSettings() {
        return {
            url: Lampa.Storage.get('jellyfin_nas_server', 'https://jellyfin.brama24.xyz').replace(/\/$/, '').trim(),
            token: Lampa.Storage.get('jellyfin_nas_token', '3c683816bf314b3c9bbf45e93334dc69').trim()
        };
    }
