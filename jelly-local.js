(function () {
  ...
  var DEFAULT_URL = 'http://192.168.1.161:8096';
  var DEFAULT_API_KEY = 'a4393364ae8b45b28f76506cd6b19cd0';
  ...
  function addLang() {
    Lampa.Lang.add({
      jellyfin_title: { en: 'Jellyfin', ru: 'Jellyfin', uk: 'Jellyfin' },
      jellyfin_movies: { en: 'Movies', ru: 'Фильмы', uk: 'Фільми' },
      jellyfin_series: { en: 'TV Series', ru: 'Сериалы', uk: 'Серіали' },
      jellyfin_resume: { en: 'Continue watching', ru: 'Продолжить просмотр', uk: 'Продовжити перегляд' },
      jellyfin_latest: { en: 'Latest added', ru: 'Недавно добавлено', uk: 'Недавно додано' },
      jellyfin_stat_resume: { en: 'Continue', ru: 'Продолжить', uk: 'Продовжити' },
      jellyfin_stat_latest: { en: 'Latest', ru: 'Недавние', uk: 'Недавні' },
      jellyfin_stat_movies: { en: 'Movies', ru: 'Фильмы', uk: 'Фільми' },
      jellyfin_stat_series: { en: 'Series', ru: 'Сериалы', uk: 'Серіали' },
      jellyfin_play: { en: 'Play', ru: 'Смотреть', uk: 'Дивитися' },
      jellyfin_open_card: { en: 'Open card', ru: 'Открыть карточку', uk: 'Відкрити карточку' },
      jellyfin_episodes: { en: 'Episodes', ru: 'Эпизоды', uk: 'Епізоди' },
      jellyfin_pick_episode: { en: 'Choose episode', ru: 'Выберите эпизод', uk: 'Оберіть епізод' },
      jellyfin_empty: { en: 'Library is empty', ru: 'Библиотека пуста', uk: 'Бібліотека пуста' },
      jellyfin_empty_descr: {
        ...
        uk: 'Додайте медіа в Jellyfin або перевірте налаштування підключення',
      },
      jellyfin_retry: { en: 'Retry', ru: 'Повторить', uk: 'Повторити' },
      jellyfin_open_settings: { en: 'Open settings', ru: 'Открыть настройки', uk: 'Відкрити налаштування' },
      jellyfin_auth_ok: { en: 'Connection OK', ru: 'Подключение успешно', uk: 'Підключення успішне' },
      jellyfin_auth_fail: { en: 'Connection failed', ru: 'Не удалось подключиться', uk: 'Не вдалось підключитися' },
      jellyfin_test: { en: 'Test connection', ru: 'Проверить подключение', uk: 'Перевірити підключення' },
      jellyfin_url: { en: 'Server URL', ru: 'URL сервера', uk: 'URL сервера' },
      jellyfin_key: { en: 'API key', ru: 'API-ключ', uk: 'API-ключ' },
      jellyfin_no_tmdb: {
        en: 'No TMDB id on this item',
        ru: 'Нет TMDB id у этого элемента',
        uk: 'Немає TMDB id у цього елемента',
      },
      jellyfin_error: { en: 'Something went wrong', ru: 'Что-то пошло не так', uk: 'Щось пішло не так' },
      jellyfin_settings_name: { en: 'Jellyfin', ru: 'Jellyfin', uk: 'Jellyfin' },
      jellyfin_settings_hint: {
        en: 'Jellyfin URL and API key from Dashboard → API Keys',
        ru: 'URL Jellyfin и API-ключ из Панель → Ключи API',
        uk: 'URL Jellyfin і API-ключ з Панель → Ключі API',
      },
      jellyfin_set_dedupe: {
        en: 'Merge duplicates (TMDB)',
        ru: 'Объединять дубликаты (TMDB)',
        uk: 'Об\'єднувати дубліката (TMDB)',
      },
      jellyfin_set_hide_folders: {
        en: 'Hide release folders',
        ru: 'Скрывать папки релизов',
        uk: 'Приховати папки релізів',
      },
      jellyfin_set_tmdb_posters: {
        en: 'TMDB posters & titles',
        ru: 'Постеры и названия из TMDB',
        uk: 'Постери і назви з TMDB',
      },
      jellyfin_set_full_button: {
        en: 'Play button on Lampa card',
        ru: 'Кнопка воспроизведения на карточке',
        uk: 'Кнопка відтворення на карточці',
      },
      jellyfin_more: { en: 'More', ru: 'Ещё', uk: 'Ще' },
      jellyfin_libraries: { en: 'Library', ru: 'Библиотека', uk: 'Бібліотека' },
      jellyfin_set_tap_play: {
        en: 'Tap card to play (long = menu)',
        ru: 'Нажатие — смотреть (долгое — меню)',
        uk: 'Натискання — дивитися (довге — меню)',
      },
      jellyfin_set_transcode: {
        en: 'HLS transcoding (Lampa player)',
        ru: 'HLS-транскодинг (плеер Lampa)',
        uk: 'HLS-трансодування (плеєр Lampa)',
      },
      jellyfin_set_stream_hint: {
        ...
        uk: 'Якщо увімкнено, плеєр Lampa використовує HLS-трансодування з вибором якості. Зовнішні плеєри завжди отримують прямий потік.',
      },
      jellyfin_play_from_library: {
        en: 'Play from Jellyfin',
        ru: 'Смотреть из Jellyfin',
        uk: 'Дивитися з Jellyfin',
      },
      jellyfin_pick_quality: { en: 'Choose quality', ru: 'Выберите качество', uk: 'Оберіть якість' },
      jellyfin_play_4k: { en: 'Play 4K', ru: 'Смотреть 4K', uk: 'Дивитися 4K' },
      jellyfin_play_1080: { en: 'Play 1080p', ru: 'Смотреть 1080p', uk: 'Дивитися 1080p' },
      jellyfin_watched: { en: 'Watched', ru: 'Просмотрено', uk: 'Переглянуто' },
      jellyfin_mark_watched: { en: 'Mark as watched', ru: 'Отметить просмотренным', uk: 'Позначити як переглянуте' },
      jellyfin_mark_unwatched: { en: 'Mark as unwatched', ru: 'Снять отметку просмотра', uk: 'Зняти відмітку перегляду' },
      jellyfin_mark_watched_ok: { en: 'Marked as watched', ru: 'Отмечено как просмотрено', uk: 'Позначено як переглянуте' },
      jellyfin_mark_unwatched_ok: { en: 'Marked as unwatched', ru: 'Отметка просмотра снята', uk: 'Відмітка перегляду знята' },
      jellyfin_season_n: { en: 'Season {0}', ru: 'Сезон {0}', uk: 'Сезон {0}' },
      jellyfin_user: { en: 'Jellyfin user', ru: 'Пользователь Jellyfin', uk: 'Користувач Jellyfin' },
      jellyfin_user_pick: { en: 'Choose user', ru: 'Выбрать пользователя', uk: 'Вибрати користувача' },
      jellyfin_user_auto: { en: 'First user (auto)', ru: 'Первый пользователь (авто)', uk: 'Перший користувач (авто)' },
    });
  }
